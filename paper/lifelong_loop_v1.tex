...
\date{July 2026 --- v1.1 (preprint, doi:10.5281/zenodo.21310038; code \& raw timelines: doi:10.5281/zenodo.21309811)}
...
suffices; that serving with all adapters mounted is free) fail measurably here. Test-time weight adaptation is also reaching world models: AdaJEPA
\citep{wang2026adajepa} updates a latent world model inside the model-predictive-control loop, one
error-driven gradient step per replan --- adaptation for \emph{immediate control}, where the
environment re-supplies ground-truth transitions at every step. Our setting is the complement:
adaptation for \emph{retention}, where nothing re-supplies a fact unless it was logged --- one
reason the log is load-bearing here and no analogous dependency arises there.
...
\bibitem[Wang et al.(2026)]{wang2026adajepa} Wang, Y., Bounou, O., LeCun, Y., \& Ren, M. AdaJEPA:
An adaptive latent world model. arXiv:2606.32026.
...
\bibitem[Lee et al.(2026)]{letThemSleep2026} Lee, S., McLeish, S., Goldstein, T., \& Fanti, G.
Do language models need sleep? Offline recurrence for improved online inference. arXiv:2605.26099.

\bibitem[Shinde(2026)]{scm2026} Shinde, S.~S. SCM: Sleep-consolidated memory with algorithmic
forgetting for large language models. arXiv:2604.20943.
